...
$(document).ready(function () {
    ...
    $(".section h2").click(function () {
        ...
        // Masquer tous les <p>, puis afficher uniquement celui lié avec effet de fade
        $(".section p").not("#" + pId).hide("slow"); // Masquer les autres paragraphes
        $("#" + pId).toggle("slow"); // Afficher le paragraphe spécifique
    });
});
